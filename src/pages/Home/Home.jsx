...
const Home = () => {
  ...
  return (
    <div className=' min-h-screen pb-10 font-sans'>
      ...
      <Container
        maxWidth='lg'
        className='flex z-10 gap-x-6 mt-30 justify-center animate-fade-in-up'
      >
        {' '}
        {/* Tăng khoảng cách mt-10, thêm justify-center */}
      ...
      <Container maxWidth='lg' className='mt-10'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6 animate-fade-in-up'>
          {' '}
          {/* Sử dụng grid cho bố cục responsive */}
          <div className='border border-[#e3e8ee] py-5 px-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 bg-white animate-fade-in-up'>
            {' '}
            {/* Điều chỉnh padding, thêm shadow, rounded */}
            <div className='flex items-start gap-x-3 border-b border-[#eee] pb-3 mb-3'>
              {' '}
              {/* Thêm items-start */}
              <Plane
                className='p-2 rounded-full !bg-[#d1f0ff] min-w-[40px] min-h-[40px]'
                size={24}
              ></Plane>{' '}
              {/* Tăng padding, thêm min-w/h */}
              <div className='flex-grow'>
                <p className='font-bold text-lg'>Giảm ngay 50K</p>{' '}
                {/* Tăng font size */}
            ...
            <div className='flex items-center justify-between gap-x-2'>
              <div className='flex bg-[#e8faff] p-2 rounded-md w-full gap-x-2 items-center'>
                {' '}
                {/* Điều chỉnh màu nền, thêm rounded, items-center */}
                <Copy size={18}></Copy>
                <p className='font-semibold text-[#073e68]'>BKBANMOI</p>{' '}
                {/* Thêm font-semibold, màu chữ */}
              </div>
              <Button
          ...
          <div className='bg-white p-6 shadow-2xl rounded-2xl hover:shadow-3xl hover:brightness-95 transition-all duration-300 hover:scale-105 animate-fade-in-up'>
            ...
            <div className=''>
              <div className='my-2'>
                ...
                <Typography
                  variant='subtitle1'
                  className='!font-bold !text-sm !text-amber-600'
                >
                  3.499.000 VND
                </Typography>
              </div>
              <Button
                variant='contained'
                className='!bg-gradient-to-r from-[#0194f3] to-[#20648c] !hover:from-[#007acc] !hover:to-[#0194f3] !w-full !text-lg !font-bold !rounded-full shadow-lg hover:scale-105 transition-all duration-300'
              >
                Đặt vé ngay
              </Button>
            </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6 animate-fade-in-up'>
          ...
          <div className='flex items-center bg-white shadow-xl p-6 text-black rounded-2xl hover:shadow-2xl transition-all duration-300 animate-fade-in-up'>
            <div className='w-32 flex-shrink-0 mr-4'>
              {' '}
              {/* Điều chỉnh width và thêm margin-right */}
              <img
                src={r1}
                alt='Reason 1'
          ...
          <div className='flex items-center bg-white shadow-xl p-6 text-black rounded-2xl hover:shadow-2xl transition-all duration-300 animate-fade-in-up'>
            ...
            <div className='text-sm flex-grow'>
              ...
              <Typography variant='body2' className='text-gray-700'>
                Booking luôn tìm kiếm và cung cấp cho bạn những ưu đãi tốt nhất,
                giúp bạn tiết kiệm chi phí cho chuyến đi.
              </Typography>
            </div>
          </div>
          <div className='flex items-center bg-white shadow-xl p-6 text-black rounded-2xl hover:shadow-2xl transition-all duration-300 animate-fade-in-up'>
            ...
            <div className='text-sm flex-grow'>
              ...
              <Typography variant='body2' className='text-gray-700'>
                ...
                mọi thắc mắc và hỗ trợ bạn mọi lúc, mọi nơi.
              </Typography>
            </div>
          </div>
        </div>
      ...
      {/* Footer */}
      <Container>
        <div className='text-black font-bold text-xl flex justify-center mt-10 animate-fade-in'>
          {' '}
          {/* Tăng mt-10 */}
          Nhóm 3
        </div>
