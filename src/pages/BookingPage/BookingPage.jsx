        ...
        <Grid container spacing={2} sx={{ gap: 2, padding: 2, marginTop: 2 }}>
          <Grid size={4} >
            <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column', gap: 2 }}> 
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', maxHeightheight: '300', overflowY: 'auto', backgroundColor:'#f4fbff'}}>
                  ...
                  <Box sx={{ mt:1, display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: 2, borderBottom:'1px solid #ddd' }}>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                      ...
                      <Box>
                        ...
                        <Typography sx={{ color:'#687176' }}>HAN</Typography>
                      </Box>


                    </Box>
                    <Box sx={{ display: 'flex'}}>
                      <Typography className='text-red-500' sx={{fontWeight:'600'}}>1.738.440 VND</Typography>/khách
                    </Box>
                  </Box>
                  <Box></Box>
                </Box>
