                    ...
                    <Grid container spacing={15}>
                      ...
                      <Grid size={{ xs: 12, md: 6 }}>
                        <div className='border-1 max-w-[600px] rounded-t-xl rounded-b-xl'>
                          <Typography fontWeight={'bold'} className='flex items-center justify-center bg-red-500 rounded-t-xl text-white'>
                            Ghi chú
                          </Typography>
                        ...
                        <div className='mt-5 p-5 rounded-xl border-1'>
                          <div
                            className='text-center font-bold bg-red-500 rounded-xl text-white'
                          >
                          ...
                          <Grid container spacing={2}
                            direction='row' alignItems='center' className='py-2 '>
                            <Grid item xs={1}>
